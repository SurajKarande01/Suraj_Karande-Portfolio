        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {certifications.map((c, i) => (
            <motion.div
              ...
              className="group flex flex-col justify-between rounded-2xl border border-white/5 bg-card/50 p-6 transition-colors hover:border-accent/30"
            >
              <div>
                ...
                {c.desc && (
                  <p className="mt-2 text-xs text-text-muted/80 leading-relaxed">{c.desc}</p>
                )}
              </div>
              {c.certificateUrl && (
                <div className="mt-4">
                  ...
                  >
                    View Certificate <FiExternalLink className="text-[10px]" />
                  </a>
                </div>
              )}
            </motion.div>
