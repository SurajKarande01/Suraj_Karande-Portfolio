...
export default function Contact() {
  ...
  const contactCards = [
    ...
    { icon: FiGithub, label: 'GitHub', value: 'https://github.com/SurajKarande01', href: profile.github },
    { icon: FiLinkedin, label: 'LinkedIn', value: 'https://www.linkedin.com/in/surajk0001/', href: profile.linkedin },
  ]
        ...
        >
          <div className="grid gap-5 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="focus-ring w-full rounded-lg border border-white/10 bg-dark px-4 py-2.5 text-sm text-text placeholder:text-text-muted"
          ...
          <div className="mt-5">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              className="focus-ring w-full resize-none rounded-lg border border-white/10 bg-dark px-4 py-2.5 text-sm text-text placeholder:text-text-muted"
