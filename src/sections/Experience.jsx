      ...
      <div className="grid gap-12 lg:grid-cols-2">
        <div>
          <h3 className="mb-6 flex items-center gap-2 font-display text-lg font-medium text-text">
            <FiBriefcase className="text-accent" /> Training & Experience
          </h3>
          <div className="space-y-4">
            {experience.map((exp) => (
              <motion.div
                ...
                className="rounded-2xl border border-white/5 bg-card/50 p-6 flex flex-col justify-between"
              >
                <div>
                ...
                {exp.certificateUrl && (
                  <div className="mt-4 pt-2">
                    ...
                    >
                      View Training Certificate <FiExternalLink className="text-[10px]" />
                    </a>
                  </div>
                )}
              </motion.div>
